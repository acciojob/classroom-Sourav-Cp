...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
        try {
            studentService.addRelation(student, teacher);
            return new ResponseEntity<>("New student-teacher pair added successfully", HttpStatus.CREATED);
            }
        catch (TeacherNameException ex)
        {
            return new ResponseEntity<>("Teacher Name Not Present",HttpStatus.NOT_FOUND);
        }
        catch (StudentNameException ex)
        {
            return new ResponseEntity<>("Student Name Not Present",HttpStatus.NOT_FOUND);
        }
    }
